# -*- coding: utf-8 -*-
"""PacMan-DeepQ-519.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1F1q9xXUCf9OUjeGsj0RmdOshFDxXeZio
"""
...
plt.subplot(121)
plt.title("Original Screen (160×210 RGB)")
plt.imshow(obs)
plt.axis("off")
plt.subplot(122)
plt.title("After moving to greyscale (88×80 greyscale)")
...
agent.load('/content/gdrive/My Drive/Colab Notebooks/Pacman/Reward_number_0.37_Frames:_861_Episode_1_Date_2020-04-29 01:08:07.840890.pt')
